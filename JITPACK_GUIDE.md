...
**JitPack地址**：https://jitpack.io/#MufHead/YRDatabase/v1.0.2
...
dependencies {
    // 只使用API（最小依赖）
    compileOnly("com.github.MufHead.YRDatabase:yrdatabase-common:v1.0.2")

    // 或者依赖Nukkit插件（包含完整实现）
    compileOnly("com.github.MufHead.YRDatabase:yrdatabase-nukkit:v1.0.2")

    // 或者依赖WaterdogPE插件
    compileOnly("com.github.MufHead.YRDatabase:yrdatabase-waterdog:v1.0.2")
}
```
...
# 3. 创建标签
git tag -a v1.0.2 -m "Release version 1.0.1"
...
**特定版本**：https://jitpack.io/#MufHead/YRDatabase/v1.0.2
...
+--- com.github.MufHead.YRDatabase:yrdatabase-common:v1.0.2
```
...
**检查**：
1. 访问 https://jitpack.io/#MufHead/YRDatabase/v1.0.2
2. 点击 "Look up" 查看构建日志
...
```kotlin
// ❌ 错误
compileOnly("com.github.MufHead:YRDatabase:v1.0.2")
